      ...
      tree match {
        ...
        case Apply(Select(qual, _), args) =>
          ...
          if (isStaticOnly(sym)) {
            ...
            val implClass = enteringFlatten { ifaceClass.implClass } // load it, but before flatten
            // why enteringFlatten? well, if the trait's info hasn't been forced by this time, the actual
            ...
            val implMethodLst = enteringMixin(implClass.info.decls.collect {
